    ...
    if request.method == 'POST':
        if request.POST.get('form-key') == 'ثبت-مشخصات':
            ...
            if register_form.is_valid():
                owner_obj = Owner(first_name=register_form.cleaned_data['owner_firstname'],
                                  family_name=register_form.cleaned_data['owner_lastname'],
                                  nationalCode=register_form.cleaned_data['owner_nationalcode'],
                                  phone=register_form.cleaned_data['owner_phone'],
